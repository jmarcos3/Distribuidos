...
class FileSyncServer:
    ...
    def create_file(self, file_name, content):
        full_file_name = os.path.join(self.base_directory,"1"+file_name) # ele define o nome do arquivo adicionando o 1 na frente, que significa que foi criado pelo servidor
